...
export const WaltonPlan = () => {
    ...
    const [planName, setPlanName] = useState('Walton plan')
  ...
  const userId = userInfo.id
    ...
    const check = (e) => {
        ...
        e.preventDefault();
        setShowProfit('block')
        setProfit(15 / 100 * amount  )
        setTotal(15 / 100 * amount  + +amount)
        if(amount < 35000){
  ...
  return (
    <div className=' shadow-sm  h-full '>
        <div className={`${amountError} mb-3 bg-gray-200 w-[330px] rounded-sm font-nunito `}><h1 className='text-red-600 text-sm'>Amount should range from $35,000 - $100,000</h1></div>
