...
export const HalongPlan = () => {
  ...
  return (
    <div className='    mt-10  shadow-sm  h-full '>
        <div className={`${amountError} mb-3 bg-gray-200 w-[330px] rounded-sm`}><h1 className='text-red-600 text-sm'>Amount should range from $1872 - $9800</h1></div>
    
        <form className='flex flex-col gap-2'>
            <div className='flex flex-col   '>
                <label htmlFor="planName" className='text-lg font-nunito-200 text-gray-900 font-semibold'>Plan:</label>
                <input  type="text" className='border-2 p-1 w-[200px] text-xl rounded-md border-gray-600' value="Halong Rig Plan" disabled  />
            </div>
            <div className='flex flex-col '>
