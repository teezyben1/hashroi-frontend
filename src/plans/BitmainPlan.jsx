...
export const BitmainPlan = () => {
    ...
    const [planName, setPlanName] = useState('Bitmain plan')
  ...
  const userId = userInfo.id
    ...
    const check = (e) => {
        ...
        e.preventDefault();
        setShowProfit('block')
        setProfit(12 / 100 * amount )
        setTotal(12 / 100 * amount  + +amount)
        if(amount < 10000){
  ...
  return (
    <div className=' shadow-sm  h-full '>
        <div className={`${amountError} mb-3 bg-gray-200 w-[330px] rounded-sm font-nunito `}><h1 className='text-red-600 text-sm'>Amount should range from $10,000 - $34,000</h1></div>
